...
from server.mono_vo import MonoVOMixin
...
class Pogo(ServoController, MPU6050Mixin, MonoVOMixin):
    servos: list[Servo] = [
...
class SensorPogo(MPU6050Mixin, MonoVOMixin):
    servos: list[Servo] = []
    ...
    def get_data(self):
        return self.get_mpu_data() + self.get_vo_data()

...
class ComplementaryFilter:
    ...
    @property
    def g_x(self):
        return 9.81*math.cos(self.roll*math.pi/180)
    
    @property
    def g_y(self):
        return 9.81*math.sin(self.pitch*math.pi/180)
...
class SimpleVelocityFilter:
    ...
    def update(self, acc_data, g_xy):
        ...
        self.v_x = 0.9 * (self.v_x + self.a_x*dt)
        self.v_y = 0.9 * (self.v_y + self.a_y*dt)
        self.t_last = t_start
